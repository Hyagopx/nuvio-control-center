...
export default function Home() {
  ...
  function makeSnapshot(customInv = inv): Snapshot { return { schemaVersion: 4, exportedAt: new Date().toISOString(), source: 'Nuvio Control Center v0.11.6', inventory: customInv || { fetchedAt: new Date().toISOString(), profiles: [] } } }
...
function makeLocalSnapshot(inv:Inventory){return{schemaVersion:3,exportedAt:new Date().toISOString(),source:'Nuvio Control Center v0.11.6',inventory:inv}}
