...
function AddonPage({profile,rows,diag,loading,diagnose,q,setQ,selected,setSelected,update,onAdd,onEdit,onCopy,token,lastSync}:any){
 ...
 return <div className="stack management-page">
  ...
  {healthRows.length>0&&<div className="management-summary diagnostic-summary"><span><i className="green-dot"></i>{healthy} saudáveis</span><span><i className="amber-dot"></i>{attention} atenção</span><span><i className="red-dot"></i>{failedCount} manifesto indisponível</span><span>{unverifiedCount} não verificáveis</span></div>}
